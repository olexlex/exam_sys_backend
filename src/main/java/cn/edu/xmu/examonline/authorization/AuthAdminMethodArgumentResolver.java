...
@Component
public class AuthAdminMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter methodParameter) {
        if (methodParameter.getParameterType().isAssignableFrom(AuthInfo.class)
                && methodParameter.hasParameterAnnotation(AuthAdmin.class)) {
            return true;
        }
        return false;
    }
    ...
    public Object resolveArgument(MethodParameter methodParameter,
        ...
        var payload = authService.verifyTokenWithAdminRequired(token);
